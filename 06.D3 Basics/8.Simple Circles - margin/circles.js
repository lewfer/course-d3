 ...
 * Showing the use of viewbox to scale the whole chart to the screen width
 */
...
async function drawChart(container, dataFile) {
    ...
    selection
        ...
        .append("circle")                                   // create a circle for each one
            ...
            .attr("r",        d=>d.score)                   // scale the radius scaled to the score
            .style("fill",    d=>colourScale(d.player))     // set the colour per player
